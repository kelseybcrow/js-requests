...
const repeatMyParam = () => {
  ...
  return axios
    .get("http://localhost:3000/repeat/longboarding")
    .then((res) => res.data);

  const repeating = document.getElementById("repeat-text");
  repeating.textContent = res.data;
...
axios
  .get("http://localhost:3000/repeat?myquery=longboarding=skateboarding")
